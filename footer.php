...
<img src="<?php bloginfo('stylesheet_directory'); ?>/img/2030 (2).png" alt="">
<p>
السعودية - الرياض <br>
مخرج 24<br><br>
...
<!-- Vendor JS1 Files -->
<script src="<?php bloginfo('stylesheet_directory'); ?>/vendor/bootstrap/js1/bootstrap.bundle.min.js1"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/vendor/aos/aos.js1"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/vendor/glightbox/js1/glightbox.min.js1"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/vendor/isotope-layout/isotope.pkgd.min.js1"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/vendor/swiper/swiper-bundle.min.js1"></script>
<script src="<?php bloginfo('stylesheet_directory'); ?>/vendor/php-email-form/validate.js1"></script>

<!-- Template Main JS1 File -->
<script src="<?php bloginfo('stylesheet_directory'); ?>/js1/main.js1"></script>
