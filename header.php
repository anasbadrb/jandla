    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="home"><span>الرئيسية</span> </a></li>

          <li><a class="nav-link scrollto" href="home#about">من نحن</a></li>
          <li><a class="nav-link scrollto" href="home#features">خدماتنا</a></li>
          <li><a class="nav-link scrollto" href="home#services">مشاريعنا </a></li>
          <li><a class="nav-link scrollto" href="group">مجموعتنا</a></li>
          <li><a class="nav-link scrollto"  href="suppliers">الموردون</a></li>
      ...
      <a class="btn-getstarted scrollto" href="home#about">اشترك معنا </a>
