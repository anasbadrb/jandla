  ...
  <main id="main">
      ...
      <p>ومتخصصون في تقديم الحلول المختلفة للجهات الحكومية، وشبه الحكومية، وقطاع الأعمال الخاص الربحي، وغير الربحي في كل مشروع نعمل عليه نقترب نحو تحقيق الرؤية على أرض الواقع</p>
          ...
          <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-5">
              <div class="about-img">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/download (1) .png" class="img-fluid" alt="">
              </div>
            </div>
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/clients/client-1.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/clients/client-2.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/clients/client-3.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/clients/client-4.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/clients/client-5.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/clients/client-6.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/clients/client-7.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/clients/client-8.png" class="img-fluid" alt=""></div>
          </div>
        </div>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/features-1.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/features-2.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/features-3.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/features-4.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-5">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/features-5.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-6">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/features-6.svg" alt="" class="img-fluid">
              </div>
            </div>
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item">
              <div class="img">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/services-1.jpg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item">
              <div class="img">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/services-2.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            ...
            <div class="service-item">
              <div class="img">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/services-3.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="500">
            <div class="service-item">
              <div class="img">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/services-4.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="600">
            <div class="service-item">
              <div class="img">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/services-5.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="700">
            <div class="service-item">
              <div class="img">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/services-6.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="">
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
                <div class="stars">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="">
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="">
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="post-box">
              <div class="post-img"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/news.jpeg" class="img-fluid" alt=""></div>
              <div class="meta">
